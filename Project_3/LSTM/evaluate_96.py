...
def main():
    print("Starting evaluation for 96 units model...")
    
    # Config
    config_path = PROJECT_ROOT / "config" / "lstm_config_96_units.yaml"
    ...
    # Results dir
    results_dir = PROJECT_ROOT / 'results' / 'results_20251223_144936'
