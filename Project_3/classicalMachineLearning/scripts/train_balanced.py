...
logging.basicConfig(
    filename=os.path.join(log_dir, f"training_balanced_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"),
    level=logging.INFO,
...
DATA_PATH = r"c:\Users\abhay\OneDrive\Desktop\SID\Research_Internship_Under_Dr_Rakesh_Matam\Project_3\dataset\balanced_test_5k.csv"
MODEL_DIR = r"c:\Users\abhay\OneDrive\Desktop\SID\Research_Internship_Under_Dr_Rakesh_Matam\Project_3\classicalMachineLearning\models_balanced"
RESULTS_BASE_DIR = r"c:\Users\abhay\OneDrive\Desktop\SID\Research_Internship_Under_Dr_Rakesh_Matam\Project_3\classicalMachineLearning\results_balanced"
...
if __name__ == "__main__":
    try:
        ...
        with open("error_dump_balanced.txt", "w") as f:
