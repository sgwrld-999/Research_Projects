...
LOGGER = get_logger('plot_reduced_auc')
...
def plot_roc(model_path, dataset_name, test_files, output_path):
    ...
    plt.title(f'ROC Curves - {dataset_name} (Reduced Model)')
...
def main():
    ...
    # Edge-IIoT
    edge_run_id = "20_per_les_edge-iiot_phase_2_20251221_130606"
    ...
    # CICIoT
    ciciot_run_id = "20_per_les_ciciot_phase_2_20251221_130818"
