...
LOGGER = get_logger('phase2_reduced_ciciot_splits')
...
def main():
    ...
    # Define Splits
    splits = [
        ("60_40", "ciciot_training_60_40.csv", "ciciot_testing_60_40.csv"),
        ("70_30", "ciciot_training_70_30.csv", "ciciot_testing_70_30.csv"),
        ("80_20", "ciciot_training_80_20.csv", "ciciot_testing_80_20.csv")
    ]
    ...
    for split_name, train_file, test_file in splits:
        ...
        run_id = f"20_per_les_ciciot_{split_name}_{timestamp}"
    ...
    LOGGER.info("Overall Results for New CICIoT Splits:")
    LOGGER.info(overall_results)
    save_json(overall_results, logs_dir / f"20_per_les_ciciot_splits_results.json")
