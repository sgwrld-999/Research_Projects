...
LOGGER = get_logger('phase2_reduced')
...
def main():
    parser = argparse.ArgumentParser(description='Train Reduced Phase 2 Model')
    ...
    # Prefix: 20_per_les_
    run_id = f"20_per_les_{dataset_name}_phase_2_{timestamp}"
    LOGGER.info(f"Starting Reduced Training Run: {run_id}")
    ...
    # Reduced Hyperparameters (20% less)
    # Units: 64 * 0.8 = 51.2 -> 51
    # Epochs: 20 * 0.8 = 16
    # Dropout: 0.2 * 0.8 = 0.16
    # LR: 0.001 * 0.8 = 0.0008
